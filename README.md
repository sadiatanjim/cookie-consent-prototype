...
## Key Concepts & Skills Demonstrated:
  ...
  * Handling user input via forms with FormData and the .get() method
  * Controlling default browser actions using event.preventDefault()
  * Applying modern CSS techniques such as flex-direction: row-reverse and class toggling for layout and interaction
  * Managing UI states effectively with the 'disabled' attribute
